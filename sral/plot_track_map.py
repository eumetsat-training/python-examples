...
p1, = m.plot(X_20_ku[ocean_wv],Y_20_ku[ocean_wv],markersize=5.0,linewidth=0.0,marker='.',color='#4682b4',markerfacecolor='#4682b4',fillstyle='full',zorder=1)
p2, = m.plot(X_20_ku[sea_ice_wv],Y_20_ku[sea_ice_wv],markersize=5.0,linewidth=0.0,marker='.',color='#8a2be2',markerfacecolor='#8a2be2',fillstyle='full',zorder=2)
p3, = m.plot(X_20_ku[lead_wv],Y_20_ku[lead_wv],markersize=1.0,linewidth=0.0,marker='.',color='#3cb371',markerfacecolor='#3cb371',fillstyle='full',zorder=3)
m.fillcontinents(color=[0.7,0.7,0.7],zorder=zordcoast)
m.drawcoastlines(color='k',linewidth=0.5,zorder=zordcoast+1)
m.drawcountries(color='k',linewidth=0.25,zorder=zordcoast+2)
...
leg=plt.legend([p1, p2, p3],['Ocean', 'Sea ice', 'Leads'])
